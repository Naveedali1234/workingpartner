        ...
        <div class="card-body">
          ...
          <form class="form-horizontal" method="post" action="{{route('provinces.update',$province->id)}}">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input id="inputHorizontalSuccess" type="text" placeholder="Title" name="name" value="{{$province->name}}" class="form-control form-control-success"><small class="form-text">Name of the Province</small>
              </div>
            </div>            
            <div class="form-group row">       
